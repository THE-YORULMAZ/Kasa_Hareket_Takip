    ...
    public partial class Gelir : Form
    {
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd1.CommandText = "INSERT INTO Gelir(Fis_No,Tarih,Gelir_Tipi,Gelir_Tutarı,Aciklama)VALUES('" + txtfis.Text + "','" + txttarih.Text + "','" + txttip.Text + "','" + txttutar.Text + "','" + rtxtgelir.Text + "')";
        ...
        private void btnedit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd2.CommandText = "UPDATE Gelir SET Fis_No='" + txtfisg.Text + "',Tarih='" + txttarihg.Text + "',Gelir_Tipi='" + txtgtipg.Text + "',Gelir_Tutarı='" + txtgtutg.Text + "',Aciklama='" + rtxtgunc.Text + "'where ID=@NUMARA";
